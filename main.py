...
button_list = ["A", "B", "C", "D", "Del", "test"]

numpad = Numpad_buttons(button_list, voyage, numpad_frame, root)

sector_frame = ttk.Labelframe(mainwindow_frame, text="Sector control")
sector_frame.grid(column=1, row=3, rowspan=3, sticky=(S, W))

sector_1 = Sector("Sector A", 200, 100, 1, sector_frame)
sector_2 = Sector("Sector B", 100, 50, 2, sector_frame)
sector_3 = Sector("Sector C", 10, 5, 3, sector_frame)
